    ...
    <KeyboardAvoidingView
      ...
      <ScrollView
        ...
        <Box flexDirection="row" m="l" alignItems="center">
          <Box flex={0.5}>
            <Text variant="primary12bold">Question 3 out of 4</Text>
          </Box>
          <Box
            height={10}
            flex={0.5}
        ...
        <Box
          ...
          <Text
            ...
            paddingVertical="l"
            paddingHorizontal="m">{`How about the communication attitude for the contractor?`}</Text>

          <TouchableOpacity
            onPress={() => navigation.navigate('SurveyF')}
