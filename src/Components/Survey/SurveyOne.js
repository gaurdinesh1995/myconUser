    ...
    <KeyboardAvoidingView
      ...
      <ScrollView
        ...
        <Box flexDirection="row" m="l" alignItems="center">
          <Box flex={0.5}>
            <Text variant="primary12bold">Question 1 out of 4</Text>
          </Box>
          <Box
            height={10}
            flex={0.5}
        ...
        <Box
          ...
          <Text
            ...
            p="l">{`How do you think about the contractor’s completion speed?`}</Text>

          <TouchableOpacity
            onPress={() => navigation.navigate('SurveyT')}
